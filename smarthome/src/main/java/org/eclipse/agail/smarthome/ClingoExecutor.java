...
import org.eclipse.agail.smarthome.classes.HomeAppliance;
import org.eclipse.agail.smarthome.classes.Room;
import org.eclipse.agail.smarthome.classes.SmartHome;
...
public class ClingoExecutor {
	...
	public ArrayList<UserRequirements> executeWithUserRequirements(UserRequirements userRequirements) {
		...
		if (hasKnownConflict(userRequirements)) {
			return new ArrayList<UserRequirements>();
		} else {
	...
	private boolean hasKnownConflict(UserRequirements userRequirements) {
